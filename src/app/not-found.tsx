  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center bg-background dark:bg-[#18181b] px-4">
      <div className="flex flex-col items-center">
        ...
        <Link
          href="/"
          className="inline-block px-6 py-2 rounded-lg bg-primary text-primary-foreground dark:bg-primary dark:text-primary-foreground font-semibold shadow hover:bg-primary/90 dark:hover:bg-primary/90 transition"
        >
          Return Home
        </Link>
      </div>
