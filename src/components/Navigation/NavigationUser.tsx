        ...
        <div className={`max-w-[${SECTION_WIDTH}px] mx-auto px-4 sm:px-6 lg:px-8`}>
          <div className="flex justify-between items-center text-sm">
            ...
            <div className="flex items-center space-x-4" style={{ color: 'var(--muted-foreground)' }}>
              ...
              <Link href="/inquiry" className="transition-colors" style={{ color: 'inherit' }} onMouseEnter={(e) => e.currentTarget.style.color = 'var(--status-warning)'} onMouseLeave={(e) => e.currentTarget.style.color = 'inherit'}>Inquiry</Link>
                      ...
                      >
                        ...
                        >
                          {[
                            ...
                            { 
                              label: user?.role === 'seller' ? 'Dashboard' : 'Become Seller', 
                              href: user?.role === 'seller' ? '/seller/dashboard' : '/become-seller', 
                            ...
                            { label: 'My inquiries', href: '/user/inquiries', icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
