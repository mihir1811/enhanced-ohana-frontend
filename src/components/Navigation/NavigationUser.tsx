      ...
      <div className="mx-auto flex max-w-[1400px] items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <div className="relative" ref={profileRef}>
            ...
            {profileOpen && (
              <div className="absolute right-0 mt-2 w-56 rounded-xl border bg-popover p-2 text-sm text-popover-foreground shadow-lg">
                {user ? (
                  <>
        ...
        >
          ...
          {activeNav &&
            ...
            navItems.find((item) => item.label === activeNav)?.children!.length > 0 && (
              ...
              >
                <div className="inline-block max-h-[22rem] overflow-y-auto rounded-xl border border-slate-200 bg-white text-slate-900 shadow-xl dark:border-slate-800 dark:bg-slate-900 dark:text-slate-50">
